...
namespace MITAB
{
    ...
    {
        /// <summary>Не геометрия</summary>
        TABFC_NoGeom = 0,
        /// <summary>Точка</summary>
        TABFC_Point = 1,
        /// <summary>Точка_</summary>
        TABFC_FontPoint = 2,
        /// <summary>Точка__</summary>
        TABFC_CustomPoint = 3,
    ...
    /// <summary>Расстояние между символами в тексте</summary>
    ...
    /// <summary>Расстояние между строками текста</summary>
    ...
    /// <summary>Wrapper functions for the version 1.3.0 of the MapInfo Tab API.</summary>
    /// <remarks>
    ...
    public class MiApi
    {
        ...
        /// <summary>Получение текста последней ошибки</summary>
        /// <returns></returns>
        ...
        /// <summary>Fetch the last error number. </summary>
        ...
        /// <summary>Open an existing .TAB or .MIF dataset for read access. </summary>
        ...
        /// <summary>Create a new .TAB or .MIF dataset.</summary>
        /// <remarks>
        ...
        /// <param name="handle">Хэндл слоя</param>
        /// <param name="field_name">Имя поля</param>
        /// <param name="field_type">Тип поля</param>
        /// <param name="width">Ширина</param>
        /// <param name="precision">Точность</param>
        /// <param name="indexed">Индексированное</param>
        /// <param name="unique">Уникальное</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Запись сущности</summary>
        /// <param name="handle">Хэндл слоя</param>
        /// <param name="feature">Хэндл сущности</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Read a mitab_feature object from the file.</summary>
        ...
        /// <summary>Destroy a mitab_feature object and release all memory associated with it. </summary>
        ...
        /// <summary>Get the text string on a TABFC_Text object. </summary>
        ...
        /// <summary>Получение текста</summary>
        ...
        /// <summary>Настройка форматирования текста</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="angle">Угол поворота</param>
        /// <param name="height">Высота</param>
        /// <param name="width">Ширина</param>
        /// <param name="fg_color">Цвет</param>
        /// <param name="bg_color">Цвет фона</param>
        /// <param name="justification">Выравнивание</param>
        /// <param name="spacing">Отступы</param>
        /// <param name="linetype">Тип линий</param>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Получить цвет пера</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        public static extern int mitab_c_get_pen_color(IntPtr feature);

        /// <summary>Получить ширину пера</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        public static extern int mitab_c_get_pen_width(IntPtr feature);

        /// <summary>Получить паттерн пера</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        public static extern int mitab_c_get_pen_pattern(IntPtr feature);

        /// <summary>Установка заливки сущности</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="fg_color">Цвет</param>
        /// <param name="bg_color">Цвет фона</param>
        /// <param name="pattern">Паттерн</param>
        /// <param name="transparent">Прозрачность</param>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Установить шрифт</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="font_name">Имя шрифта</param>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Получить имя шрифта</summary>
        /// <param name="feature"></param>
        /// <returns></returns>
        ...
        /// <summary>Установить символ для сущности</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="symbol_no">Номер символа</param>
        /// <param name="symbol_size">Размер символа</param>
        /// <param name="symbol_color">Цвет символа</param>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Устанавливаем значения координат точек сущности</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="part">Индекс части</param>
        /// <param name="vertex_count">Количество точек</param>
        /// <param name="x">Массив x-значений</param>
        /// <param name="y">Массив y-значений</param>
        [DllImport("mitab.dll")]
        public static extern void mitab_c_set_points(IntPtr feature, int part,
            int vertex_count, double[] x, double[] y); //ref double x, ref double y 

        /// <summary>Устанавливаем значения дуги</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="center_x">Координата x центра</param>
        /// <param name="center_y">Координата y центра</param>
        /// <param name="x_radius">Радиус по оси x</param>
        /// <param name="y_radius">Радиус по оси y</param>
        ...
        /// <summary>Return a mitab_feature's object type. </summary>
        /// <param name="feature">The mitab_feature object.</param>
        ...
        /// <summary>Return the number of parts (rings or polyline segments) in an object. </summary>
        /// <param name="feature">The mitab_feature object.</param>
        ...
        /// <summary>Return the number of points in a part of a mitab_feature object. </summary>
        /// <param name="feature">The mitab_feature object.</param>
        ...
        /// <summary>Return the X coordinate of a point in a part of a mitab_feature object.</summary>
        /// <param name="feature">The mitab_feature object.</param>
        ...
        /// <summary>Return the Y coordinate of a point in a part of a mitab_feature object.</summary>
        /// <param name="feature">The mitab_feature object.</param>
        /// <param name="part">The part number we are interested in. Use 0 for objects which cannot have multiple parts.</param>
        /// <param name="vertex">The point number, with 0 being the first point.</param>
        ...
        /// <summary>Return the number of features in a dataset.</summary>
        ...
        /// <summary>Return the number of attribute fields in a dataset's schema.</summary>
        /// <param name="handle">The dataset's handle.</param>
        ...
        /// <summary>Return the type of an attribute field in a dataset's schema. </summary>
        /// <param name="handle">The dataset's handle.</param>
        ...
        /// <summary>Return the name of an attribute field in a dataset's schema. </summary>
        /// <param name="handle">The dataset's handle.</param>
        /// <param name="field">The index of the field to look at, with 0 being the first field.</param>
        ...
        /// <summary>Получить имя поля</summary>
        /// <param name="handle">Хэндл сущности</param>
        /// <param name="field">Индекс поля</param>
        /// <returns></returns>
        ...
        /// <summary>Return the width of an attribute field in a dataset's schema. </summary>
        /// <param name="handle">The dataset's handle.</param>
        /// <param name="field">The index of the field to look at, with 0 being the first field.</param>
        ...
        /// <summary>Return the precision of an attribute field in a dataset's schema. </summary>
        /// <param name="handle">The dataset's handle.</param>
        /// <param name="field">The index of the field to look at, with 0 being the first field.</param>
        ...
        /// <summary>Fetch an attribute field value in a mitab_feature as a string.</summary>
        ...
        /// <summary>Получить значение поля как строку</summary>
        /// <param name="feature">Хэндл сущности</param>
        /// <param name="field">Индекс поля</param>
        /// <returns></returns>
        ...
        /// <summary>Fetch an attribute field value in a mitab_feature as a double</summary>
        /// <param name="feature">The mitab_feature object.</param>
        /// <param name="field">The index of the field to look at, with 0 being the first field.</param>
        ...
        /// <param name="dataset">Хэндл набора данных</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        public static extern IntPtr mitab_c_get_projinfo(IntPtr dataset);

        /// <summary>Установить описание проекции</summary>
        /// <param name="dataset">Хэндл набора данных</param>
        /// <param name="projinfo">Описание проекции</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        ...
        /// <summary>Получить описание системы координат mif-файла</summary>
        /// <param name="dataset">Хэндл набора данных</param>
        /// <returns></returns>
        ...
        /// <summary>Получить расширенное описание системы координат mif-файла</summary>
        /// <param name="dataset">Хэндл набора данных</param>
        /// <returns></returns>
        ...
        /// <summary>Загрузить таблицу описания систем координат</summary>
        /// <param name="filename">Имя файла</param>
        /// <returns></returns>
        [DllImport("mitab.dll")]
        public static extern int mitab_c_load_coordsys_table([MarshalAs(UnmanagedType.LPStr)] string filename);

        /// <summary>Return a false if the ring is the first of a polygon. </summary>
        /// <param name="feature">The mitab_feature object.</param>
